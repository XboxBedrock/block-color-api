module me/xboxbedrock/minecraft/imageserver

go 1.22.4

require (
	dmitri.shuralyov.com/font/woff2 v0.0.0-20180220214647-957792cbbdab // indirect
	github.com/ConradIrwin/font v0.0.0-20190603172541-e12dbea4cf12 // indirect
	github.com/Crosse/gosimplelogger v0.2.0 // indirect
